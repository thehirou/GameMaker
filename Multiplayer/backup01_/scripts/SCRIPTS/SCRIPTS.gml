...
{
if !instance_exists(oMyEntity){instance_create_depth(x,y-sprite_height+16,depth,oMyEntity, {displayIcon : _sprite})}
if instance_exists(oMyEntity)
{
oMyEntity.displayIcon=_sprite
}
